...
% scale, but ordered): last decoder activation 32 ch, broadcast z 6 ch, and the
% three f_comb 1x1 convs 38->38->38->2. The blue last-activation block and the
% green z block TOUCH, because concatenation makes them one tensor; f_comb is
% set off by a gap, because it is a separate computation -- and it is the stage
% the Section 3 nonlinearity bug lived in.
...
\fill[fm] (8.80,-1.50) rectangle (8.92,-0.30);
\fill[fm] (8.98,-1.50) rectangle (9.02,-0.30);
\node[lbl] at (8.82,-0.06) {$f_{\text{comb}}$};
...
\draw[flow] (9.02,-1.20) -- (10.30,-1.20);
...
\draw[oflow] (8.86,-1.50) -- (8.86,-2.50) -- (16.00,-2.50) -- (16.00,0.62);
